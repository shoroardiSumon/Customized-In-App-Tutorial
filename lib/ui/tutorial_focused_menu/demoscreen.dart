...
class _DemonstrationState extends State<Demonstration> {
  static const String screenName = 'demo';
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: TutorialScreen(
        ...
        tutorialKeyCount: 5, // Only 3 tutorials for this screen
        child: Scaffold(
              ...
              child: Column(
                ...
                children: [
                  ...
                  CommonFocusedMenuHolder(
                    ...
                    popupChild: const Text('This is the information for Widget 4.'),
                    child: Container(
                      height: 120,
                      alignment: Alignment.center,
                      decoration: const BoxDecoration(
                  ...
                  CommonFocusedMenuHolder (
                    ...
                    popupChild: const Text('This is the information for Widget 5.'),
                    child: Container(
                      height: 180,
                      alignment: Alignment.center,
                      decoration: const BoxDecoration(
